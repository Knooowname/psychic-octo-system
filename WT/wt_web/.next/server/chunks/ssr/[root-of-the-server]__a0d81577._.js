...
const AuthForm = ()=>{
    ...
    const handleClickAuth = async (data)=>{
        try {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reducers$2f$userSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setUser"])(dataUser.data[0]));
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reducers$2f$taskSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchTasksExecutor"])(dataUser.data[0].id));
            router.push('/');
        } catch (error) {
            console.error(error);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a0d81577._.js.map