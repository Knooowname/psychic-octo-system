...
const useAuth = ()=>{
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAppSelector$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "useAuth.useAppSelector[user]": (state)=>state.user.user
    }["useAuth.useAppSelector[user]"]);
    const login = (userData)=>{
        localStorage.setItem('user', JSON.stringify(userData));
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reducers$2f$userSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setUser"])(userData));
    };
    const logout = ()=>{
        localStorage.removeItem('user');
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reducers$2f$userSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearUser"])());
    };
    return {
        user,
        login,
...
_s(useAuth, "PUsG6M2CQS/nMcpUf65pa7COufI=", false, function() {
    return [
...
const AuthForm = ()=>{
    ...
    const tasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAppSelector$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "AuthForm.useAppSelector[tasks]": (state)=>state.task.tasks
    }["AuthForm.useAppSelector[tasks]"]);
    const { user, login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleClickAuth = async (data)=>{
        try {
            ...
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reducers$2f$userSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setUser"])(dataUser.data[0]));
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reducers$2f$taskSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTasksExecutor"])(dataUser.data[0].id));
            router.push('/');
        } catch (error) {
            console.error(error);
        }
...
_s(AuthForm, "Zh1AYcbuDKNli2fzfNn8jn2JZ+4=", false, function() {
    return [
...
//# sourceMappingURL=src_9c957545._.js.map