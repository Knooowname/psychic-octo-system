        ...
        "TabTasksInProcess.useEffect": ()=>{
            async function fetchUsers() {
                ...
                const filteredAuthor = dataUsers.filter({
                    "TabTasksInProcess.useEffect.fetchUsers.filteredAuthor": (item)=>item.id === data.authorid
                }["TabTasksInProcess.useEffect.fetchUsers.filteredAuthor"]);
...
_s(TabTasksInProcess, "yJx5Ev0q7hV2n/TG5FQD6rfz4es=");
...
function Executor() {
    ...
    const [tasks, setTasks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
...
_s(Executor, "i5EMBRkrJjXOmRZZq7rF1AgH8Sg=", false, function() {
    return [
...
//# sourceMappingURL=src_2aecba65._.js.map