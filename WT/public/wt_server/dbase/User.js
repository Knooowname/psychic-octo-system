...
var config_json_1 = __importDefault(require("../../wt_config/config.json"));
...
var User = (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        sess = crypto_1.default
                            ...
                            .digest("hex");
                        return [4, this.db.query("INSERT INTO user_sess (id, uid, sess_code) " +
                                "VALUES (" +
                                id +
                                ", " +
    ...
    User.prototype.selectUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.args.user_sess === undefined)) return [3, 2];
                        pass = crypto_1.default
                            .createHmac("sha256", config_json_1.default.crypto_code)
                            .update(this.args.password)
                            .digest("hex");
                        return [4, this.db.query('select users.id, users.login, users.firstname, users.lastname from users where login = \'' + this.args.login + '\' and password = \'' + pass + '\'')];
                    case 1:
                        db_response = _a.sent();
                        return [2, db_response.rows];
                    case 2: return [4, this.db.query("SELECT " +
    ...
    User.prototype.deleteSessionCode = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.db.query("DELETE FROM user_sess WHERE sess_code = '" + this.args.user_sess + "'")];
                    case 1:
                        _a.sent();
                        return [2];
                }
                ...
                switch (_a.label) {
                    case 0:
                        pass = crypto_1.default
                            ...
                            .update(this.args.password)
                            .digest("hex");
                        return [4, this.db.query("update users set password = \'" + pass + "\' " +
