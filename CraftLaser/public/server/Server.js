...
var Server = (function () {
    ...
    Server.prototype.route = function () {
        ...
        this.app.get("/", function (req, res) {
            res.render("index.hbs", { app: "home" });
        });
        this.app.get("/about", function (req, res) {
            res.render("index.hbs", { app: "about" });
        });
        this.app.get("/catalog", function (req, res) {
            res.render("index.hbs", { app: "catalog" });
        });
        this.app.get("/reviews", function (req, res) {
            res.render("index.hbs", { app: "reviews" });
        });
        this.app.get("/auth", function (req, res) {
            res.render("index.hbs", { app: "auth" });
        });
        this.app.get("/register", function (req, res) {
            res.render("index.hbs", { app: "register" });
        });
        this.app.get("/account", function (req, res) {
            res.render("index.hbs", { app: "account" });
        });
        this.app.get("/admin", function (req, res) {
            res.render("index.hbs", { app: "admin" });
        });
        this.app.use(body_parser_1.default.json({ limit: '300mb' }));
